...
| accountId | 12345 | URI-Pfad | Adobe Pass-Authentifizierung UpstreamUserID-Metadaten nach der Benutzeranmeldung [User Metadata UpstreamUserID - Adobe Pass-Authentifizierung](/help/authentication/user-metadata-feature.md) |
