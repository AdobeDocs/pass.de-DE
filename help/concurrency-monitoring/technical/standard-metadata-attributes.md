...
Die Parallelitätsüberwachungs-API zwingt Clients, im Rahmen eines gültigen Initialisierungsaufrufs die folgenden Werte zu senden: [Sitzungsinitiierungsaufrufe](/help/concurrency-monitoring/technical/restrict-concurr-usage-mult-apps.md#api-calls-descr).
...
Wenn bei [API v2.](https://streams-stage.adobeprimetime.com/swagger-ui/index.html) eines dieser Attribute für die definierten Richtlinien erforderlich ist, führt ein Sitzungsinittierungsversuch ohne dieses Attribut zu einer 400-Fehler-Anfrage.
...
* [Entscheidungspunkt der Richtlinie](/help/concurrency-monitoring/technical/cm-policy-decision-point.md)
* [API-Konsole - Adobe-Parallelitätsüberwachung](https://streams-stage.adobeprimetime.com/swagger-ui/index.html)
