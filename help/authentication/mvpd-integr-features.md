...
| 1,4 | [Single-Sign-on-Unterstützung](/help/authentication/sso-support.md) | Der Viewer meldet sich mit dem MVPD auf der Site einer Marke an und kann dann zu einer anderen Marke wechseln und nicht aufgefordert werden, sich erneut anzumelden. Die AuthN-Sitzung wird von den Marken gemeinsam genutzt. SSO-Unterstützung ist sowohl für Websites als auch für Mobile-/Device-Anwendungen verfügbar.  Bei MVPDs muss entweder eine Benutzer-ID oder ein anderes Benutzer-Token zurückgegeben werden, das für AuthZ über verschiedene Marken hinweg verwendet werden kann. | A |                                                                                                                                                         |
...
| 1,7 | [Dienstanbieterumfang](/help/authentication/serv-provider-scoping.md) | MVPD unterstützt die Übergabe der Markenkennung (Anforderungswert) in der AuthN-Anfrage. | A- | Dies ermöglicht eine dienstanbieterspezifische Anmeldung. |
