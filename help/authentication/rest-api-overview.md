...
Um die Adobe Pass Authentication REST API verwenden zu können, müssen Geräte die im Abschnitt REST API des Felds [Adobe Pass-Authentifizierungs-Plattform/Dokument mit Anforderungen an Geräte/Tools](#general_clientless_reqs).
