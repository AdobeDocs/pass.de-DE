...
1. Suchen Sie die Benachrichtigung Überprüfen und Push-Änderungen unten auf dem Bildschirm.
   ...
   ![Überprüfen und Push-Benachrichtigung](/help/authentication/assets/tve-dashboard/new-tve-dashboard/review/review-and-push-changes-banner-view.png)
...
1. Geben Sie eine kurze Beschreibung der Änderung in **Konfigurationsbeschreibung** ein, um den Zweck jeder Änderung effektiv zu verfolgen und zu verstehen.
   ...
   ![Fügen Sie eine Konfigurationsbeschreibung hinzu](/help/authentication/assets/tve-dashboard/new-tve-dashboard/review/review-and-push-configuration-details-panel-view.png)
...
1. Wählen Sie **Anzeigen** aus, um die vorherigen und neuen Werte zu überprüfen, die mit einer Konfigurationsänderung verbunden sind.
   ...
   ![Konfigurationsänderungen anzeigen](/help/authentication/assets/tve-dashboard/new-tve-dashboard/review/review-and-push-changes-view-button.png)
...
1. Nachdem Sie alle Änderungen überprüft haben und alles korrekt aussieht, wählen Sie **Push-Änderungen** aus, um die aktualisierte Konfiguration auf den Server anzuwenden.
   ...
   ![Änderungen per Push übertragen](/help/authentication/assets/tve-dashboard/new-tve-dashboard/review/review-and-push-push-changes-button.png)
