...
<table style="table-layout:auto">
   ...
   <tr>
      ...
      <td>
        Die endgültige Umleitungs-URL, zu der der Benutzeragent navigiert, wenn der Abmeldefluss für die MVPD abgeschlossen ist.<br/><br/>
        Der Wert muss URL-kodiert sein.</td>
      <td><i>required</i></td>
   </tr>
   <tr>
      ...
      <td>
         ...
         <table style="table-layout:auto">
            ...
            <tr>
               ...
               <td>
                  Die Aktion, die das Streaming-Gerät ausführen muss, um den Abmeldefluss abzuschließen.<br/><br/>
            ...
            <tr>
               ...
               <td>
                  Die URL, die zum Ausführen des Abmeldevorgangs mit dem MVPD-Endpunkt verwendet wird.<br/><br/>
                  Dies ist für die folgenden Werte des Attributs „actionName“ nicht vorhanden:<ul>
...
### &#x200B;1. Initiieren des Abmeldens für ein bestimmtes MVPD mit Abmeldeendpunkt
...
### &#x200B;2. Starten des Abmeldens für einen bestimmten MVPD ohne Abmeldeendpunkt
...
### &#x200B;4. Initiieren des einmaligen Abmeldens für bestimmte MVPDs, einschließlich der Profile, die durch einmaliges Anmelden mit der Platform-Identitätsmethode abgerufen wurden
...
### &#x200B;5. Initiieren des Abmeldens für bestimmte MVPD-Profile, einschließlich Profilen, die über Single Sign-on mit Partner (Apple) abgerufen wurden
...
### &#x200B;6. Initiieren des Logouts für bestimmte MVPDs bei angewendeter Degradation
...
### &#x200B;7. Initiieren der Abmeldung für Basic- oder Promotion-TempPass (nicht erforderlich)
