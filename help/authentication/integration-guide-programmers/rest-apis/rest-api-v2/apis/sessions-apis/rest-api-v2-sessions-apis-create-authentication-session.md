...
<table style="table-layout:auto">
   ...
   <tr>
      ...
      <td>
        ...
        Weitere Informationen zu Flüssen, die Single Sign-on mit einem Service-Token aktivieren, finden Sie in der Dokumentation <a href="../../flows/single-sign-on-access-flows/rest-api-v2-single-sign-on-service-token-flows.md">Single Sign-on mit Service-Token-Flüssen</a> .<td>fakultativ</td>
   </tr>
   <tr>
...
### &#x200B;4. Authentifizierungssitzung mit einfachem oder Promotional TempPass erstellen (nicht erforderlich)
