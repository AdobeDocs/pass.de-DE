...
Weitere Informationen zur REST API V2 insgesamt finden Sie in der Dokumentation [REST API V2 - Übersicht](rest-api-v2-overview.md) .
...
In der Registrierungsphase wird die Client-Anwendung über den DCR-Prozess (Dynamic Client Registration[ für die Adobe Pass-Authentifizierung ](rest-api-v2-glossary.md#dcr).
...
Die Software-Anweisung ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#software-statement) definiert ist.

Die Software-Anweisung besteht aus einem JSON Web Token (JWT), das von einem Ihrer Organisationsadministratoren oder einem in Ihrem Namen handelnden Adobe Pass-Authentifizierungsmitarbeiter ](rest-api-v2-glossary.md#tve-dashboard) Adobe Pass [TVE Dashboard) generiert und heruntergeladen werden kann.
...
Dieser Vorgang kann über das Adobe Pass [TVE-Dashboard](rest-api-v2-glossary.md#tve-dashboard) von einem Ihrer Organisationsadministratoren oder einem in Ihrem Namen handelnden Adobe Pass-Authentifizierungsmitarbeiter ausgeführt werden.
...
* Die Client-Programme, die die widerrufene Software-Anweisung verwenden, können die Flüsse für [Berechtigungen“ nicht mehr durchlaufen](rest-api-v2-glossary.md#entitlement) was bedeutet, dass Benutzende vom Abspielen von Inhalten ausgeschlossen werden.

### 6. Was sind Client-Anmeldeinformationen und wie lange sind sie gültig? {#registration-phase-faq6}

Die Client-Anmeldeinformationen sind ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#client-credentials) definiert ist.

Die Client-Anmeldeinformationen bestehen aus einer Client-Kennung und einem Client-Geheimnistenpaar, die vom Client-Registrierungs-Endpunkt abgerufen werden können.
...
Das Zugriffstoken ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#access-token) definiert ist.
...
Die Konfiguration ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#configuration) definiert ist.
...
Die Authentifizierungssitzung ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#session) definiert ist.
...
Der Authentifizierungs-Code ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#code) definiert ist.
...
Das Profil ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#profile) definiert ist.
...
Die Vorautorisierung ist ein Begriff, der in der [Glossar](rest-api-v2-glossary.md#preauthorization)-Dokumentation definiert ist, während der Entscheidungsbegriff auch im [Glossar) ](rest-api-v2-glossary.md#decision) ist.
...
Die Ressource ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#resource) definiert ist.
...
Die Autorisierungsphase ist obligatorisch. Die Client-Anwendung kann diese Phase nicht überspringen, wenn sie die von der Benutzerin oder dem Benutzer angeforderten Ressourcen wiedergeben möchte, da sie bzw. er sich vor der Freigabe des Streams bei der MVPD vergewissern muss, dass die Benutzerin oder der Benutzer berechtigt ist.

### 3. Was ist eine Zulassungsentscheidung und wie lange ist sie gültig? {#authorization-phase-faq3}

Der Begriff Autorisierung ist in der [Glossar](rest-api-v2-glossary.md#authorization)-Dokumentation definiert, während der Begriff Entscheidung auch im [Glossar) ](rest-api-v2-glossary.md#decision) ist.
...
Das Medien-Token ist ein Begriff, der in der Dokumentation [Glossar](rest-api-v2-glossary.md#media-token) definiert ist.
...
Die Client-Anwendung kann die vorhandenen benutzerdefinierten Schemata wiederverwenden, die über das Adobe Pass-[TVE-Dashboard) generiert ](rest-api-v2-glossary.md#tve-dashboard).
...
Die Client-Anwendung kann denselben Fluss weiterhin verwenden, um sich über den [Dynamische Client-Registrierung (DCR) bei der Adobe Pass](rest-api-v2-glossary.md#dcr)Authentifizierung zu registrieren und ein Zugriffstoken zu erhalten.
