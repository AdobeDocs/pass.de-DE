---
title: REST API V2-KI-Regeln
description: REST API V2-KI-Regeln
...
# REST API V2-KI-Regeln {#rest-api-v2-ai-rules}

>[!IMPORTANT]
>
> Der Inhalt dieser Seite dient nur zu Informationszwecken. Die Verwendung dieser API erfordert eine aktuelle Lizenz von Adobe. Eine unbefugte Nutzung ist nicht zulässig.

Dieses Dokument bietet Kunden von Adobe Pass Authentication strukturierte Regeln und Best Practices, die speziell für die KI-unterstützte Entwicklung von TVE-Anwendungen (TV Everywhere) mit [REST-API V2](rest-api-v2-overview.md) entwickelt wurden.

Durch Befolgen der in diesem Handbuch beschriebenen KI-Entwicklungsregeln können Entwicklerinnen und Entwickler sicherstellen, dass ihre KI-Kodierungs-Assistenten beim Erstellen konformer, leistungsstarker und verwaltbarer Integrationen helfen, die den [obligatorischen Anforderungen und empfohlenen Praktiken](rest-api-v2-checklist.md) entsprechen.

## Regeln für Kodierungs-Assistenten {#coding-assistants-rules}

Regeln enthalten Anweisungen auf Systemebene für Agenten. Stellen Sie sie sich als persistenten Kontext, Voreinstellungen oder Workflows vor. Die Regeln in diesem Dokument sind mit gängigen KI-gestützten Kodierungs-Assistenten kompatibel und wandeln die [REST API V2 Checkliste](rest-api-v2-checklist.md) in umsetzbare KI-Entwicklungsrichtlinien um.

Beginnen Sie noch heute mit der Konfiguration Ihrer KI-Entwicklungsumgebung mit unserem umfassenden Regelsatz und erleben Sie die Vorteile einer intelligenten, konformen Code-Generierung für Ihre Adobe Pass Authentication REST API V2-Integration. Kopieren Sie die folgenden Regeln und fügen Sie sie je nach verwendetem KI-Tool in die Konfigurationsdatei Ihrer Entwicklungsumgebung ein.
...
- Retrieve configuration for specific service provider: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-configuration-apis/rest-api-v2-configuration-apis-retrieve-configuration-for-specific-service-provider
- Create authentication session: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-create-authentication-session
- Resume authentication session: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-resume-authentication-session
- Retrieve authentication session: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-retrieve-authentication-session-information-using-code
- Perform authentication in user agent: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-perform-authentication-in-user-agent
- Retrieve profiles: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profiles
- Retrieve profile for specific mvpd: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-mvpd
- Retrieve profile for specific code: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-code
- Retrieve authorization decisions using specific mvpd: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-authorization-decisions-using-specific-mvpd
- Retrieve preauthorization decisions using specific mvpd: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-preauthorization-decisions-using-specific-mvpd
- Initiate logout for specific mvpd: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-logout-apis/rest-api-v2-logout-apis-initiate-logout-for-specific-mvpd
- Retrieve partner authentication request: https://experienceleague.adobe.com/de/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-partner-single-sign-on-apis/rest-api-v2-partner-single-sign-on-apis-retrieve-partner-authentication-request
