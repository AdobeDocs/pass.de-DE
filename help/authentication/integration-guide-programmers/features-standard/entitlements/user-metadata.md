...
Zum Ver- und Entschlüsseln von Benutzermetadatenattributen muss der Programmierer ein Zertifikat (Paar aus öffentlichem/privatem Schlüssel) generieren und [ Zertifikat über das ](#management)Adobe Pass TVE Dashboard[ selbst konfigurieren](https://experience.adobe.com/#/pass/authentication) oder den öffentlichen Schlüssel mit Adobe Pass-Authentifizierungsbeauftragten teilen.
