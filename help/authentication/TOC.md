...
+ {#kickstart}
   ...
   + [Eskalationsverfahren](kickstart/escalation-procedures.md)
+ Integrationshandbuch für Programmierer {#integration-guide-programmers}
      ...
      + REST API V2-{#rest-api-v2}
         ...
         + API-{#rest-api-v2-apis}
            ...
            + Partner-Single-Sign-On-{#rest-api-v2-partner-single-sign-on-apis}
               ...
               + [Abrufen des Profils mit der Antwort der Partnerauthentifizierung](integration-guide-programmers/rest-apis/rest-api-v2/apis/partner-single-sign-on-apis/rest-api-v2-partner-single-sign-on-apis-retrieve-profile-using-partner-authentication-response.md)
   ...
   + {#standard-features} Standardfunktionen
      + Berechtigungen {#entitlements}
         ...
         + [Integrieren von Media Token Verifier](integration-guide-programmers/features-standard/entitlements/media-token-verifier-int.md)
   ...
   + Premium-Funktionen {#features-premium}
      + Temporärer {#temporary-access}
         + [Temporärer Durchlauf](integration-guide-programmers/features-premium/temporary-access/temp-pass.md)
         + [Temporärer Pass für Werbeaktionen](integration-guide-programmers/features-premium/temporary-access/promotional-temp-pass.md)
         + [Temporären Pass zurücksetzen](integration-guide-programmers/features-premium/temporary-access/reset-temp-pass.md)
      + Heruntergestufte {#degraded-access}
         + [API-Übersicht zur Beeinträchtigung](integration-guide-programmers/features-premium/degraded-access/degradation-api-overview.md)
      + ESM {#esm}
   ...
   + Legacy-{#legacy}
      + (Legacy) REST API v1-{#rest-api-v1}
         ...
         + (Veraltete) APIs {#rest-api-v1-apis}
      ...
      + (Legacy) TVE Dashboard {#tve-dashboard}
         + [Benutzerhandbuch für das (veraltete) TVE-Dashboard](integration-guide-programmers/legacy/tve-dashboard/tve-dashboard-user-guide.md)
      + (Legacy) Technische Hinweise {#tech-notes}
         + (Legacy) REST API v1-{#rest-api-v1}
         ...
         + (Ältere) SDKs {#sdks}
            ...
            + (Legacy) iOS/tvOS SDK {#ios-tvos-sdk}
               ...
               + [(Legacy) Temporären Pass auf iOS zurücksetzen](integration-guide-programmers/legacy/notes-technical/reset-temp-pass-on-ios.md)
   ...
   + [Handbuch zur Programmiererintegration - Übersicht](integration-guide-programmers/programmer-integration-guide-overview.md)
   + [Fluss der Programmiererberechtigungen](integration-guide-programmers/entitlement-flow.md)
